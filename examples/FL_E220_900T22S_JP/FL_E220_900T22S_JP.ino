...
void loop() {
    ...
    //青ボタン  M5STACK-DUALBUTTON-UNIT
    if(digitalRead(SW_pinA) == LOW){
        Serial.println("SW_pinA ");
        ...
        LoRa1.send_string(0x00,0x00,0x0A,string122);
...
*/
        ...
        //delay(500);
        while(digitalRead(SW_pinA) == LOW){ 
            delay(10);
        }
    }

    //赤ボタン　M5STACK-DUALBUTTON-UNIT
    if(digitalRead(SW_pinB) == LOW){
        Serial.println("SW_pinB ");
